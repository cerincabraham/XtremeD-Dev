...
if [ ! -e /etc/updatingBW.png ]; then
	sudo wget https://raw.githubusercontent.com/Cerin-Photonic3D/Photonic3D-Dev/master/host/common/etc/updatingBW.png
	sudo mv updatingBW.png /etc/
fi
# Dev version 0.38
if [ ! -e /etc/updating.png ]; then
	sudo wget https://raw.githubusercontent.com/Cerin-Photonic3D/Photonic3D-Dev/master/host/common/etc/updating.png
